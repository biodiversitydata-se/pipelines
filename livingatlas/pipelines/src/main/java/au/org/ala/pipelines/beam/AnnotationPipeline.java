...
public class AnnotationPipeline {
  ...
  public static void run(ALAInterpretationPipelineOptions options) throws Exception {
  ...
  public static String convertToLocal(ALAInterpretationPipelineOptions options, String inputPath)
      throws IOException {
